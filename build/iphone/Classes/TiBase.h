...
// in simulator we redefine to format for ARkit Developer console
...
{\
	NSString * exceptionName = [@"org.arkit." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.arkit";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIARkitNativeItemNone = -1, 
	UIARkitNativeItemSpinner = -2,
	UIARkitNativeItemProgressBar = -3,
	
	UIARkitNativeItemSlider = -4,
	UIARkitNativeItemSwitch = -5,
	UIARkitNativeItemMultiButton = -6,
	UIARkitNativeItemSegmented = -7,
	
	UIARkitNativeItemTextView = -8,
	UIARkitNativeItemTextField = -9,
	UIARkitNativeItemSearchBar = -10,
	
	UIARkitNativeItemPicker = -11,
	UIARkitNativeItemDatePicker = -12,
	
	UIARkitNativeItemInfoLight = -13,
	UIARkitNativeItemInfoDark = -14,
	
	UIARkitNativeItemDisclosure = -15,
	
	UIARkitNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all ARkit instances of
